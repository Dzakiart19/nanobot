...
from dzeck.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("dzeck.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("dzeck.agent.tools.web.httpx.AsyncClient", FakeClient)
