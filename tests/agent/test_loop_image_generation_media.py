...
from dzeck.config.loader import set_config_path
from dzeck.config.schema import ImageGenerationToolConfig, ProviderConfig, ToolsConfig
from dzeck.providers.base import LLMResponse, ToolCallRequest
from dzeck.providers.image_generation import GeneratedImageResponse
...
async def test_outbound_no_longer_carries_generated_media(
    ...
    monkeypatch.setattr(
        "dzeck.agent.tools.image_generation.get_image_gen_provider",
