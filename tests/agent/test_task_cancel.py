...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from dzeck.command.builtin import cmd_stop
        from dzeck.command.router import CommandContext
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("dzeck.agent.tools.filesystem.ListDirTool.execute", fake_execute)

        from dzeck.agent.subagent import SubagentStatus
