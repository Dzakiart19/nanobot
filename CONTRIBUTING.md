# Contributing to Dzeck

Thank you for being here.

Dzeck is built with a simple belief: good tools should feel calm, clear, and humane.
...
Use your primary HKUDS/Dzeck remote in place of `upstream` if your checkout
...
# so running it across `Dzeck/` produces a large unrelated diff
...
We care about more than passing lint. We want Dzeck to stay small, calm, and readable.
...
Please feel free to open an [issue](https://github.com/HKUDS/Dzeck/issues), join the community, or simply reach out:

- [Discord](https://discord.gg/MnCvHqpUGB)
- [Feishu/WeChat](./COMMUNICATION.md)
- Email: Xubin Ren (@Re-bin) — <xubinrencs@gmail.com>

Thank you for spending your time and care on Dzeck. We would love for more people to participate in this community, and we genuinely welcome contributions of all sizes.
