...
import type { SendImage, SendOptions } from "@/hooks/useDzeckStream";
import type {
  CliAppInfo,
  GoalStateWsPayload,
  McpPresetInfo,
...
const SLASH_RECENTS_STORAGE_KEY = "dzeck.webui.slashCommandRecents";
const SLASH_RECENTS_LIMIT = 5;
const QUEUED_PROMPTS_STORAGE_PREFIX = "dzeck.webui.composerQueuedGuidance.v1:";
  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="Dzeck-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="Dzeck-goal-panel-title"
          tabIndex={-1}
          className={cn(
      ...
      >
        ...
        {canExpandGoal ? (
          <button
            ...
            aria-controls={goalPanelOpen ? "Dzeck-goal-panel-root" : undefined}
