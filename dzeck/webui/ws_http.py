...
from dzeck.command.builtin import builtin_command_palette
from dzeck.utils.subagent_channel_display import scrub_subagent_messages_for_channel
from dzeck.webui.gateway_tokens import GatewayTokenStore, token_response_payload
...
from dzeck.webui.media_gateway import WebUIMediaGateway
from dzeck.webui.sidebar_state import (
    read_webui_sidebar_state,
    write_webui_sidebar_state,
)
from dzeck.webui.thread_disk import delete_webui_thread
from dzeck.webui.transcript import build_webui_thread_response
from dzeck.webui.workspaces import WebUIWorkspaceController
...
class GatewayHTTPHandler:
    ...
    def __init__(
        ...
        *,
        ...
        from dzeck.webui.settings_api import runtime_capabilities as _rc
        from dzeck.webui.settings_routes import WebUISettingsRouter
    ...
    def _handle_bootstrap(self, connection: Any, request: Any) -> Response:
        ...
        if email and password:
            # MongoDB auth path
            try:
                from dzeck.auth.mongodb_auth import login_user
    ...
    def _handle_signup(self, request: Any) -> Response:
        ...
        try:
            from dzeck.auth.mongodb_auth import signup_user
    ...
    def _handle_download(self, token: str) -> Response:
        from dzeck.webui.download_registry import get_download
