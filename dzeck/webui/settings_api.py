...
from dzeck.config.loader import get_config_path, load_config, save_config
...
from dzeck.security.workspace_access import workspace_sandbox_status
from dzeck.webui.workspaces import (
...
def _oauth_provider_status(spec: Any) -> dict[str, Any]:
    ...
    if spec.name == "github_copilot":
        try:
            from dzeck.providers.github_copilot_provider import get_github_copilot_login_status
        except Exception:
            return {
                "configured": False,
                "account": None,
...
def login_oauth_provider(query: QueryParams) -> dict[str, Any]:
    ...
    if spec.name == "github_copilot":
        try:
            from dzeck.providers.github_copilot_provider import (
