"""High-level programmatic interface to dzeck."""
...
from dzeck.agent.hook import AgentHook, SDKCaptureHook
...
class Dzeck:
    """Programmatic facade for running the Dzeck agent.
    ...
    async def __aenter__(self) -> "Dzeck":
        return self
