...
from dzeck.agent.hook import AgentHook, AgentHookContext, AgentRunHookContext
from dzeck.agent.tools.registry import ToolRegistry
from dzeck.providers.base import LLMProvider, LLMResponse, ToolCallRequest
from dzeck.utils.file_edit_events import (
...
from dzeck.utils.helpers import (
...
from dzeck.utils.progress_events import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set DZECK_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("DZECK_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (DZECK_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded DZECK_LLM_TIMEOUT_S.
