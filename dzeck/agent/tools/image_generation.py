...
from dzeck.security.workspace_access import current_tool_workspace
from dzeck.config.paths import get_media_dir
from dzeck.config.schema import Base
from dzeck.providers.image_generation import (
    ImageGenerationError,
    ImageGenerationProvider,
    get_image_gen_provider,
)
from dzeck.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
from dzeck.utils.artifacts import (
    ArtifactError,
...
if TYPE_CHECKING:
    from dzeck.config.schema import ProviderConfig
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        try:
            ...
            raise ImageGenerationError(
                "reference_images must be inside the workspace or Dzeck media directory"
            ) from exc
