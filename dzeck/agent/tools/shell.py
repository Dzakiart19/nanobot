...
from dzeck.agent.tools.base import Tool, tool_parameters
from dzeck.agent.tools.context import current_request_session_key
from dzeck.agent.tools.exec_session import (
...
from dzeck.agent.tools.sandbox import wrap_command
...
from dzeck.security.workspace_access import current_scope_allows_loopback, current_tool_workspace
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = (deny_patterns or []) + [
            ...
            r":\(\)\s*\{.*\};\s*:",          # fork bomb
            # Block writes to Dzeck internal state files (#2989).
    ...
    def _guard_command(
        ...
        *,
        ...
        from dzeck.security.network import contains_internal_url
