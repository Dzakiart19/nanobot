...
from dzeck.agent.tools.context import ContextAware, RequestContext
from dzeck.agent.tools.path_utils import resolve_workspace_path
from dzeck.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from dzeck.security.workspace_access import current_tool_workspace
from dzeck.bus.events import OutboundMessage
from dzeck.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from dzeck.utils.helpers import strip_think
