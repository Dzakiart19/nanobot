...
from dzeck.agent import context as agent_context
from dzeck.agent import model_presets as preset_helpers
from dzeck.agent.autocompact import AutoCompact
from dzeck.agent.context import ContextBuilder
from dzeck.agent.hook import AgentHook, CompositeHook
from dzeck.agent.memory import Consolidator
from dzeck.agent.progress_hook import AgentProgressHook
from dzeck.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from dzeck.agent.subagent import SubagentManager
from dzeck.agent.tools.context import RequestContext, bind_request_context, reset_request_context
from dzeck.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from dzeck.agent.tools.message import MessageTool
from dzeck.agent.tools.registry import ToolRegistry
from dzeck.agent.tools.self import MyTool
from dzeck.bus.events import InboundMessage, OutboundMessage
from dzeck.bus.progress import build_bus_progress_callback
from dzeck.bus.queue import MessageBus
from dzeck.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
    ensure_runtime_event_publisher,
)
from dzeck.command import CommandContext, CommandRouter, register_builtin_commands
from dzeck.config.schema import AgentDefaults, ModelPresetConfig
from dzeck.providers.base import LLMProvider
from dzeck.providers.factory import ProviderSnapshot
from dzeck.security.workspace_access import (
    WorkspaceScopeResolver,
    bind_workspace_scope,
    reset_workspace_scope,
)
from dzeck.session import turn_continuation
from dzeck.session.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from dzeck.session.manager import Session, SessionManager
from dzeck.utils.document import extract_documents, reference_non_image_attachments
from dzeck.utils.helpers import image_placeholder_text
from dzeck.utils.helpers import truncate_text as truncate_text_fn
from dzeck.utils.image_generation_intent import image_generation_prompt
from dzeck.utils.llm_runtime import LLMRuntime
from dzeck.utils.runtime import (
    EMPTY_FINAL_RESPONSE_MESSAGE,
    SUSTAINED_GOAL_CONTINUE_PROMPT,
)

if TYPE_CHECKING:
    from dzeck.config.schema import (
        ChannelsConfig,
        ProviderConfig,
        ToolsConfig,
    )
...
class AgentLoop:
    ...
    def __init__(
        ...
        from dzeck.config.schema import ToolsConfig
        ...
        # DZECK_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("DZECK_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    def _set_tool_context(
        ...
        from dzeck.agent.tools.context import ContextAware
        ...
        *on_stream_end(resuming)*: called when a streaming session finishes.
        ...
        try:
            result = await self.runner.run(AgentRunSpec(
                ...
                # Sustained goals may legitimately exceed DZECK_LLM_TIMEOUT_S; idle stall
                # is still capped by DZECK_STREAM_IDLE_TIMEOUT_S in streaming providers.
