...
This directory contains built-in skills that extend Dzeck's capabilities.
...
When skills reference large local documentation or logs, prefer Dzeck's built-in
