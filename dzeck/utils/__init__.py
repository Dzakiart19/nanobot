...
from dzeck.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "dzeck.webui.thread_disk",
    "webui_transcript": "dzeck.webui.transcript",
    "webui_turn_helpers": "dzeck.session.webui_turns",
}
