...
def _ensure_bridge_setup() -> Path:
    ...
    """
    from dzeck.config.paths import get_bridge_install_dir

    user_bridge = get_bridge_install_dir()
    stamp_file = user_bridge / ".dzeck-bridge-source-hash"
    ...
    if not source:
        raise RuntimeError(
            ...
            "Try reinstalling: pip install --force-reinstall dzeck"
        )
