...
from dzeck.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical Dzeck commands."""
    ...
    def _queue_key_for_message(message) -> str:
        """Return the final Dzeck session key used for ordered Telegram ingress."""
