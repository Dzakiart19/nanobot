...
from dzeck.cron.types import CronSchedule

if TYPE_CHECKING:
    from dzeck.agent.tools.cli_apps import CliAppsToolConfig
    from dzeck.agent.tools.image_generation import ImageGenerationToolConfig
    from dzeck.agent.tools.self import MyToolConfig
    from dzeck.agent.tools.shell import ExecToolConfig
    from dzeck.agent.tools.web import WebToolsConfig
...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from dzeck.providers.base import GenerationSettings
...
class ToolsConfig(Base):
    ...
    web: WebToolsConfig = Field(default_factory=lambda: _lazy_default("dzeck.agent.tools.web", "WebToolsConfig"))
    exec: ExecToolConfig = Field(default_factory=lambda: _lazy_default("dzeck.agent.tools.shell", "ExecToolConfig"))
    cli_apps: CliAppsToolConfig = Field(default_factory=lambda: _lazy_default("dzeck.agent.tools.cli_apps", "CliAppsToolConfig"))
    my: MyToolConfig = Field(default_factory=lambda: _lazy_default("dzeck.agent.tools.self", "MyToolConfig"))
    image_generation: ImageGenerationToolConfig = Field(
        default_factory=lambda: _lazy_default("dzeck.agent.tools.image_generation", "ImageGenerationToolConfig"),
    )
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from dzeck.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
    ...
    from dzeck.agent.tools.self import MyToolConfig
    from dzeck.agent.tools.shell import ExecToolConfig
    from dzeck.agent.tools.web import WebFetchConfig, WebSearchConfig, WebToolsConfig
