...
Persistent storage at ``~/.dzeck/pairing.json`` keeps approved senders
...
from dzeck.config.paths import get_data_dir
from dzeck.utils.helpers import _write_text_atomic
