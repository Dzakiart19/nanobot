...
If you discover a security vulnerability in Dzeck, please report it by:
...
- ✅ Run Dzeck with a dedicated user account
...
- Subscribe to security advisories for Dzeck and its dependencies
...
2. **Use a Dedicated User**
   ```bash
   sudo useradd -m -s /bin/bash Dzeck
   sudo -u Dzeck Dzeck gateway
   ```
...
- **Chat history is stored locally** - protect the `~/.Dzeck` directory
...
- GitHub Security Advisories: https://github.com/HKUDS/Dzeck/security/advisories
- Release Notes: https://github.com/HKUDS/Dzeck/releases
