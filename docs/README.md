...
For the latest documentation, visit [Dzeck.wiki](https://Dzeck.wiki/docs/latest/getting-started/Dzeck-overview).
...
| Chat apps | [`chat-apps.md`](./chat-apps.md) | Connect Dzeck to Telegram, Discord, WeChat, and more |
| Agent social network | [`agent-social-network.md`](./agent-social-network.md) | Join external agent communities from Dzeck |
...
| Topic | Repo docs | What it covers |
|---|---|---|
| Memory | [`memory.md`](./memory.md) | How Dzeck stores, consolidates, and restores memory |
| Python SDK | [`python-sdk.md`](./python-sdk.md) | Use Dzeck programmatically from Python |
