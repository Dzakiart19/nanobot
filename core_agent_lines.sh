...
echo "dzeck line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "dzeck/agent")
core_bus=$(count_top_level_py_lines "dzeck/bus")
core_config=$(count_top_level_py_lines "dzeck/config")
core_cron=$(count_top_level_py_lines "dzeck/cron")
core_session=$(count_top_level_py_lines "dzeck/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "dzeck/agent/tools")
extra_skills=$(count_skill_lines "dzeck/skills")
extra_api=$(count_recursive_py_lines "dzeck/api")
extra_cli=$(count_recursive_py_lines "dzeck/cli")
extra_channels=$(count_recursive_py_lines "dzeck/channels")
extra_utils=$(count_recursive_py_lines "dzeck/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under dzeck/agent"
echo "  - tools/ is counted separately from dzeck/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, dzeck.py, root files"
